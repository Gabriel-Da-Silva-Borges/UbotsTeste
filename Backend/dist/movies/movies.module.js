...
const movie_entity_1 = require("./movies/movie/movie.entity");
const rating_entity_1 = require("./movies/rating/rating.entity");
let MoviesModule = class MoviesModule {
};
exports.MoviesModule = MoviesModule;
exports.MoviesModule = MoviesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([movie_entity_1.Movie, rating_entity_1.Rating])],
